...
urlpatterns = [
    ...
    path('sales/new/', SaleCreateView.as_view(), name='new_sale'),
    path('sales_delete/<str:pk>/', SaleDeleteView.as_view(), name='delete_sale'),
    path('sales/<str:billno>/', SaleBillView.as_view(), name='sale_bill'),
]